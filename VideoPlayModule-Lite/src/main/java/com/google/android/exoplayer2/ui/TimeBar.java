...
public interface TimeBar {
     ...
     * @see View#isEnabled() View#isEnabled()
     */
     ...
     *
     * @param adGroupTimesMs An array where the first {@code adGroupCount} elements are the times of     ad groups in milliseconds. May be {@code null} if there are no ad groups.
     * @param playedAdGroups An array where the first {@code adGroupCount} elements indicate whether     the corresponding ad groups have been played. May be {@code null} if there are no ad     groups.
