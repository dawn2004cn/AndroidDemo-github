...
import com.count.android.cache.DiskLruCache.Editor;
import com.count.android.cache.DiskLruCache.Snapshot;
...
public class TwoLevelLruCache<V> {
    ...
    private static void quietlyAbortUnlessCommitted(Editor editor) {
