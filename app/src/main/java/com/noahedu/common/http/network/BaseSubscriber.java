...
public class BaseSubscriber implements Observer {
    ...
    private com.noahedu.common.http.network.RequestResult RequestResult;
    private Disposable d;
    private String requestType;

    public BaseSubscriber(String type, com.noahedu.common.http.network.RequestResult RequestResult) {
    ...
    public void onNext(Object t) {
        if (null != t) {
            RequestResult.onRequestSuc(requestType,(String)t);
        }
    }
    ...
    public void onError(Throwable throwable) {
        ...
        RequestResult.onRequestErr(requestType,errorMsg);
    }
