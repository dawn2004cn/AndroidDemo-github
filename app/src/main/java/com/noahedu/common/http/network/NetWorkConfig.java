package com.noahedu.common.http.network;
...
public class NetWorkConfig {
     ...
     * get请求模式
     */
    public void get(String url, HashMap<String, String> param, String requestType, RequestResult requestResult, Config config) {
        getRetrofitFactory(config)
                .getApiService().get(url, param)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new BaseSubscriber(requestType,requestResult));
    }

    /**
     * post请求模式
     */
    public void post(String url, HashMap<String, String> param, String requestType, RequestResult requestResult, Config config) {
        getRetrofitFactory(config)
     ...
     * post请求模式  参数body形式
     */
    public void post(String url, Object body, String requestType, RequestResult requestResult, Config config) {
        getRetrofitFactory(config)
     ...
     * post请求模式  表单形式
     */
    public void postField(Context mContext, String url, HashMap<String, String> fieldMap, String requestType, RequestResult requestResult, Config config) {
        getRetrofitFactory(config)
     ...
     * 图片上传   单图上传  未测试
     */
    public void upLoadFile(Context mContext, String url, String filePath, String requestType, RequestResult requestResult, Config config) {
        getRetrofitFactory(config)
     ...
     * 图片下载  未测试
     */
    public void downloadFile(Context mContext, String url, String requestType, RequestResult requestResult, Config config) {
        getRetrofitFactory(config)
...
//====================================================结束=========================================================
     ...
     */
    private RetrofitFactory getRetrofitFactory(Config config) {
