...
import com.noahedu.common.entity.XmlLabelData;
...
public class XmlUtils {
    ...
    public static <T extends Object> List<T> xmlPullObjList(String xml, String xmlLabelList[],
        ...
        if (xmlLabelList == null) {
            Log.e("XmlUtils.xmlPullObjList()", "xmlLabelList存放XML字标签为空");
            return list;
        }
        try {
            // 是为了XML集合对象存储定义的变量
    ...
    public static List<Hashtable<String, String>> xmlPullAttributeList(
        ...
        if (xmlLabel == null) {
            Log.e("XmlUtils.xmlPullAttributeList()", "xmlLabel存放XML标签和属性数组的集合为空");
            return list;
        }
        try {
            Hashtable<String, String> hash = null;
