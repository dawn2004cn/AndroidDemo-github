...
public class BroadcastReceiverDemo extends BaseActivity {
    ...
    private final static String                    ACTION_GENERAL_SEND = "com.noahedu.demo.BroadcastReceiverDemo.sendGeneralBroadcast";
    private final static String                    ACTION_LOCAL_SEND   = "com.noahedu.demo.BroadcastReceiverDemo.sendLocalBroadcast";
    private final static String                    ACTION_ORDERED_SEND = "com.noahedu.demo.BroadcastReceiverDemo.sendOrderedBroadcast";
    private final static String                    ACTION_STICKY_SEND  = "com.noahedu.demo.BroadcastReceiverDemo.sendStickyBroadcast";
