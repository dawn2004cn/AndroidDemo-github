...
public class BroadcastReceiverDemo extends BaseActivity {
    ...
    private final static String                    ACTION_GENERAL_SEND = "com.noahedu.demo.activity.BroadcastReceiverDemo.sendGeneralBroadcast";
    private final static String                    ACTION_LOCAL_SEND   = "com.noahedu.demo.activity.BroadcastReceiverDemo.sendLocalBroadcast";
    private final static String                    ACTION_ORDERED_SEND = "com.noahedu.demo.activity.BroadcastReceiverDemo.sendOrderedBroadcast";
    private final static String                    ACTION_STICKY_SEND  = "com.noahedu.demo.activity.BroadcastReceiverDemo.sendStickyBroadcast";
