...
import com.noahedu.common.util.DownloadManagerPro;
import com.noahedu.common.util.PreferencesUtils;
...
public class DownloadManagerDemo extends BaseActivity {
    ...
    public static final String     DOWNLOAD_FOLDER_NAME = "NoahDownload";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // see android mainfest.xml, accept minetype of com.noahedu.download.file
    ...
    private void initData() {
        ...
        downloadButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                request.setMimeType("application/com.noahedu.download.file");
