...
import com.noahedu.common.util.TimeUtils;
...
public class DownloadFileListAdapter extends BaseAdapter implements OnRetryableFileDownloadStatusListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cacheConvertView == null) {
            cacheConvertView = View.inflate(parent.getContext(), R.layout.download_file_item, null);
        ...
        if ("apk".equalsIgnoreCase(FileUtil.getFileSuffix(downloadFileInfo.getFileName()))) {// apk
            ivIcon.setImageResource(R.drawable.main__ic_apk);
        } else {
        ...
        switch (downloadFileInfo.getStatus()) {
            ...
            case Status.DOWNLOAD_STATUS_COMPLETED:
                ...
                if ("apk".equalsIgnoreCase(FileUtil.getFileSuffix(downloadFileInfo.getFileName()))) {// apk
                    String packageName = ApkUtils.getUnInstallApkPackageName(mActivity, downloadFileInfo.getFilePath());
                    boolean isInstall = ApkUtils.checkAppInstalled(mActivity, packageName);
                    if (isInstall) {
                    ...
                    switch (curDownloadFileInfo.getStatus()) {
                        ...
                        case Status.DOWNLOAD_STATUS_COMPLETED:
                            ...
                            {// apk
                                ...
                                final String packageName = ApkUtils.getUnInstallApkPackageName(context, 
                                        curDownloadFileInfo.getFilePath());
                                boolean isInstall = ApkUtils.checkAppInstalled(context, packageName);
                                ...
                                if (isInstall) {
                                    if (tvText2 != null) {
                                        ...
                                        try {
                                            ...
                                            e.printStackTrace();
                                            // show install dialog
                                            ApkUtils.installApk(context, curDownloadFileInfo.getFilePath());
    ...
    public void onFileDownloadStatusDownloading(DownloadFileInfo downloadFileInfo, float downloadSpeed, long 
        ...
        if (cacheConvertView != null) {
            ...
            String speed = ((float) (Math.round(downloadSpeed * 100)) / 100) + "KB/s" + "  " + TimeUtils
