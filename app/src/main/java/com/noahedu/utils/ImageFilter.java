...
public class ImageFilter {
    ...
    public Bitmap changeGrey() {
        ...
        pixels = ImageUtils.getColors(image, iw, ih);
        ...
        return ImageUtils.createBitmap(pixels, iw, ih);
    }
    ...
    public Bitmap sharp() {
        ...
        return ImageUtils.createBitmap(tempPixels, iw, ih);
    }
    ...
    /** 平滑缩放 */
 	/* public Bitmap scaling(double s) {
 		 AffineTransform tx = new AffineTransform();
 		 tx.scale(s, s);
 		 AffineTransformOp op = new AffineTransformOp(tx, AffineTransformOp.TYPE_BILINEAR);
 		 return op.filter(image, null);
 	 }
 	public Bitmap scale(Float s) {
