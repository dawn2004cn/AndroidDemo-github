	...
	private Handler mHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case HANDLE_SHOW_ACTIVITY:
				if (!isHome())
				{
					System.out.print("this is home,add this window"+msg.obj);
					if (isAdded)
					{
						wm.removeView(btn_floatView);
						isAdded = false;
				...
				{
					System.out.print("not is home,remove this window");
					if (isAdded)
					{
						wm.removeView(btn_floatView);
						isAdded = false;
			...
			case HANDLE_UPDATE_ACTIVITY:	
				mHandler.sendEmptyMessageDelayed(HANDLE_UPDATE_ACTIVITY, 1000);
			break;	
			}
		}
	};
