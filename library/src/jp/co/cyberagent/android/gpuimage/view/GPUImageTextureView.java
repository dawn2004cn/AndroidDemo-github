...
public class GPUImageTextureView extends GLTextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (GPUImage.ScaleType.CENTER_INSIDE == mScaleType && mBitmap != null) {
    ...
    public void setScaleType(GPUImage.ScaleType scaleType) {
        ...
        mGPUImage.setScaleType(GPUImage.ScaleType.CENTER_INSIDE == scaleType ? GPUImage.ScaleType.CENTER_INSIDE : scaleType);
    }
