...
public class XMLMapperEntityResolver implements EntityResolver {
  ...
  private static final String IBATIS_CONFIG_PUBLIC = "-//org.apache.ibatis.apache.org//DTD Config 3.0//EN".toUpperCase(Locale.ENGLISH);
  private static final String IBATIS_CONFIG_SYSTEM = "http://org.apache.ibatis.apache.org/dtd/org.apache.ibatis-3-config.dtd".toUpperCase(Locale.ENGLISH);

  private static final String IBATIS_MAPPER_PUBLIC = "-//org.apache.ibatis.apache.org//DTD Mapper 3.0//EN".toUpperCase(Locale.ENGLISH);
  private static final String IBATIS_MAPPER_SYSTEM = "http://org.apache.ibatis.apache.org/dtd/org.apache.ibatis-3-mapper.dtd".toUpperCase(Locale.ENGLISH);
  ...
  private static final String MYBATIS_CONFIG_DTD = "org/apache/org.apache.ibatis/builder/xml/mybatis-3-config.dtd";
  private static final String MYBATIS_MAPPER_DTD = "org/apache/org.apache.ibatis/builder/xml/mybatis-3-mapper.dtd";
